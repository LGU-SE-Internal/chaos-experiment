...
func CreateDnsChaos(cli client.Client, namespace string, appName string, action v1alpha1.DNSChaosAction, patterns []string, duration *string, labels map[string]string) (string, error) {
